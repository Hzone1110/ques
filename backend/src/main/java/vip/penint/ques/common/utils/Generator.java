...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        dc.setUrl("jdbc:mysql://localhost:3306/mt?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("vip.penint.ques.project");
        ...
        sc.setLogicDeleteFieldName("del_flag"); // 逻辑删除字段名称
