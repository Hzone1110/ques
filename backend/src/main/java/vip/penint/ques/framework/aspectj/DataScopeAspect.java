...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(vip.penint.ques.framework.aspectj.lang.annotation.DataScope)")
    ...
    protected void handleDataScope(final JoinPoint joinPoint)
    {
        ...
        {
            // 如果是超级管理员，则不过滤数据
            if (!SecurityUtils.isComAdmin(currentUser) && !SecurityUtils.isSuperAdmin(currentUser))
            {
