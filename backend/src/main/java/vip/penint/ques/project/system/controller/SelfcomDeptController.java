 ...
 */
@RestController
@RequestMapping("/selfcom/dept")
public class SelfcomDeptController extends BaseController
{
    @Autowired
    ...
    {
        dept.setComId(SecurityUtils.getCurrComId());
     ...
     * 根据部门编号获取详细信息
     */
    @PreAuthorize("@ss.hasPermi('selfcom:dept:query')")
