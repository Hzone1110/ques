...
public interface ISysUserService
{
     ...
     * @param user
     */
    void registerAnswerer(SysUser user);
     ...
     * @return
     */
    List<SysUser> selectAnswerList(SysUser user,Boolean random);

    List<Map<String, Objects>> selectAllCompany();

    String importUsers(List<SysUser> userList, boolean updateSupport, String operName, boolean answer);
