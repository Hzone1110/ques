...
import vip.penint.ques.project.system.domain.SysDept;
import vip.penint.ques.project.system.mapper.SysDeptMapper;
import vip.penint.ques.project.system.service.ISysDeptService;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    public int insertDept(SysDept dept)
    {
        ...
        if (null == dept.getParentId()) {
            dept.setParentId(0L);
            if (deptMapper.countTopByParentId(comId) >= 1) {
                throw new CustomException("只能添加一个顶级部门");
            }
            dept.setAncestors("0");
            dept.setComId(comId);
            dept.setStatus("0");
