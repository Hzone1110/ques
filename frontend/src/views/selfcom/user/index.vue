...
-->
    ...
    <el-dialog :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
      <el-upload
        ...
        :action="upload.url + '?updateSupport=' + upload.updateSupport+ '&answer=' + upload.answer"
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, exportUser, resetUserPwd, changeUserStatus, importTemplate } from "@/api/selfcom/user";
